        ...
        <CardBody>
          <AutoColumn gap="md">
            <Button
              ...
              startIcon={currency0 ? <CurrencyLogoOrg currency={currency0} style={{ marginRight: '.5rem' }} /> : null}
            ...
            <Button
              ...
              startIcon={currency1 ? <CurrencyLogoOrg currency={currency1} style={{ marginRight: '.5rem' }} /> : null}
              endIcon={<ChevronDownIcon width="24px" color="white" />}
              fullWidth
            >
